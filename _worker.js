...
// Variables
const rootDomain = "wiratunnl.biz.id"; // Ganti dengan domain utama kalian
const serviceName = "wiratunnel"; // Ganti dengan nama workers kalian
const apiKey = "2uuscvIoU37c3nHMcpLXP5fOds7IhyKZ8ItHOGrp"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "prawiraagis@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "bf2be44efedb38bfcf50c9afbbcc5b3b"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "68cce486c232da9ff493df3a6b57c528"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
